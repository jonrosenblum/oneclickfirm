    ...
    <>
      <div className="flex flex-row h-screen">
          <form onSubmit={handleSubmit} className="w-full">
            <div className="p-10">
              <div className="client-information flex flex-col bg-gray-100 m-1 p-2 py-4 rounded-md">
                ...
                {/* Old Client Information section */}
              ...
              <div className="violation-information flex flex-col bg-gray-100 p-2 m-1 py-4 rounded-md">
                ...
                {/* Old Violation Information section */}
                {/* <div className="border border-2 border-gray-300 p-2 mt-2">
                ...
                <div className="payment-information flex flex-col bg-gray-100 mt-3 py-4 rounded-md">
