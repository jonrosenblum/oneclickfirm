                ...
                >
                  <div className="px-4 py-6 mx-6 text-white text-center md:mx-6 md:p-12 ">
                    ...
                    <p className="text-sm w-full sm:w-[85%] md:w-[75%] lg:w-[60%] mx-auto">
                      Best-in-class tools for legal client intake, workflow &
                      marketing automation, legal billing, document management,
                      and much more — all in one easy-to-use law practice
                      software.
                    </p>
                  </div>
                </div>
                    ...
                    >
                      ...
                      <div className="flex items-center justify-center">
                        ...
                        <span
                          ...
                          className="mb-0 text-xs font-bold cursor-pointer"
                        >
                          Sign Up
                        </span>
                      </div>
